...
func TestSetKey(t *testing.T) {
	...
	t.Run("_gopher_original_1024x504.jpg", func(t *testing.T) {
		...
		require.Equal(t, "/tmp/test.ru/_gopher_original_1024x504.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_1024x252.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_1024x252.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_2000x1000.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_2000x1000.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_200x700.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_200x700.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_256x126.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_256x126.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_333x666.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_333x666.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
	t.Run("gopher_500x500.jpg", func(t *testing.T) {
		...
		require.Equal(t, "100_50", resizedKey)
		require.Equal(t, "/tmp/test.ru/gopher_500x500.jpg", newImageInfo.BasicFile)
		require.Equal(t, "/tmp/test.ru/", newImageInfo.BasicDir)
	})
